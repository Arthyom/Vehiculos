...
const props = defineProps({ allServices: Array, vehicle: Object });

const { serviceNoImage, vehicleNoImage } = useDefaultCommon();

const paginator = usePage().props.paginator;

const modelVehicle = `${props.vehicle.Marca} ${props.vehicle.Modelo} ${props.vehicle.Anio}`

const aliasVehicle = `${props.vehicle.Alias}`
...
<template>
    <DefaultLayout>
        <IndexTitle
            ...
            :asIndex="true"
            :useButton="true"
            :detailsTitle="modelVehicle"
            :aliasTitle="aliasVehicle"
        ></IndexTitle>
